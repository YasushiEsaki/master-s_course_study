...
epsilon = np.linspace(0.6, 1.2, 10000)
...
plt.plot(y0, color='red', label='sin(4*pi*x) + sin(8*pi*x)')
plt.plot(y2, color='blue', label='Network 1')
plt.plot(y3, color='green', label='Network 2')
plt.legend()
plt.xlabel("x")
plt.ylabel("f(x)")
plt.savefig("sin_norm_func.png")
plt.clf()
...
plt.plot(epsilon, rate2, color='blue', linestyle='solid', label='Network 1')
plt.plot(epsilon, rate3, color='blue', linestyle='dashed', label='Network 2')
plt.legend()
plt.xlabel("epsilon")
